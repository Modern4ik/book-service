package com.library.book_service.configuration;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, UserDeletedEvent> consumerFactory() {
        ...
        return new DefaultKafkaConsumerFactory<>(props, new StringDeserializer(), new JsonDeserializer<>(UserDeletedEvent.class));
    }
