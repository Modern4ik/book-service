...
public class AuthorControllerTest {
    ...
    public void shouldSaveAuthor() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/api/v1/monolith/authors")
    ...
    public void shouldReturnAuthorById() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/monolith/authors/{id}", 1))
    ...
    public void shouldReturnAuthorsByFirstNameAndBirthday() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/monolith/authors")
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    public void shouldDeleteAuthorById() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.delete("/api/v1/monolith/authors/{id}", 3))
                .andExpect(MockMvcResultMatchers.status().isNoContent());
    }

    @Test
    public void shouldNotDeleteAuthorWithIdOne() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.delete("/api/v1/monolith/authors/{id}", 1))
