...
public class BookControllerTest {
    ...
    public void shouldSaveBook() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/api/v1/monolith/books")
    ...
    public void shouldReturnBookById() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/monolith/books/{id}", 1L))
    ...
    public void shouldReturnBooksByNameAndAuthor() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/monolith/books")
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    public void shouldUpdateBookById() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.put("/api/v1/monolith/books/{id}", 1L)
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    public void shouldDeleteBookById() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.delete("/api/v1/monolith/books/{id}", 1L))
